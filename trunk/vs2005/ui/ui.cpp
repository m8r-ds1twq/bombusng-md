...
//#define TIMER_TIME 700 //¬–≈ћя ќѕ–ќ—ј “ј…ћ≈–ј
//#define TIMER_STATUS 60 //¬–≈ћя ј¬“ќ—“ј“”—ј
void CALLBACK TimerProc(HWND hwnd, UINT uMsg, UINT_PTR idEvent, DWORD dwTime);
#define STREAM_READ_IDLE 50
void recvStreamThread(void);//ѕоток обработки потока jabber
...
#define TIMER_ALIV 1000*Config::getInstance()->ping_aliv//¬–≈ћя ѕќ—ЋјЌ»я
#define TIMER_ALIVP 1000*Config::getInstance()->pong_aliv //¬–≈ћя ќ∆»ƒјЌ»я
...
#define AKTIV_PLAY 10000  //¬–≈ћя Ќј –≈ј√»–ќ¬јЌ»≈
int  aktiv_wp=0;
long aktiv_wp_sc=0;//плеер играет-значение растЄт 
long aktiv_wp_sc_not=0;//плеер не играет-значение растЄт 
...
int news_parse(void){
   ...
   info.lpDirectory = L"";
   info.nShow = SW_SHOW;
   //info.hInstApp = AfxGetInstanceHandle(); // можно не заполн€ть данное поле, и так работает
   ShellExecuteEx(&info);
   return 1;
...
{    
	...
	if(flagvs==0){
		sn.csDuration = 15;
		sn.pszTitle = TEXT("Ќовое сообщение BombusQD");
		sn.hicon = LoadIcon(g_hInst, MAKEINTRESOURCE(IDI_MESS_IC));
	}
	
	if(flagvs==1){
		sn.csDuration = 3;
		sn.pszTitle = TEXT("”ведомление BombusQD");
...
/*std::wstring dllname(appRootPath);//Ќ≈ ѕјЎ≈“ :(
			...
			switch (wmId) {
               ...
               // }
				case ID_TOOLS_COLORRE:
					...
					break;
				case NEWS:
					result=MessageBox(NULL, TEXT("ќткрыть новости? ѕри неоходимости обновите страницу"), TEXT("NEWS"), MB_YESNO | MB_ICONINFORMATION );
					if (result==IDYES){
						news_parse();
					}
					break;
				...
				case AKTIVW:
					...
					SetFocus(mainWnd);
//ќ“Ћјƒ ј ;)	MessageBox(hWnd, TEXT("Clicked"), TEXT("!"), 0);
        ...
        //Contact::ref r=roster.lock()->findContact(c->jid.getJid());
				...
				*/
                ...
                case IDM_JABBER_OFFLINE:
					...
					// Evtomax: Ѕыстрое включение/отключение звука и вибро 
				// Ќадо ещЄ сделать, чтобы галочки показывались..
...
CheckMenuItem (hMenu, ID_SIGNALS_MUTE,
        ...
        case WM_FORWARD_STANZA:
            {
                JabberDataBlockRef *rf=(JabberDataBlockRef *)lParam; //ј’“”Ќ√
                if (rf==NULL) break; 
...
ProcessResult MTForwarder::blockArrived(JabberDataBlockRef block, const ResourceContextRef rc) {
    JabberDataBlockRef *p=new JabberDataBlockRef(block); //ј’“”Ќ√
...
//int result=MessageBox(NULL, filePathavatar5.c_str(), TEXT("ќткрыть"), MB_YESNOCANCEL | MB_ICONWARNING );
BITMAP bm3;
...
//int result=MessageBox(NULL, messn1.c_str(), TEXT("ќткрыть"), MB_YESNOCANCEL | MB_ICONWARNING );
...
statusMessage2=encloseHTML(contact->getStatusMessage());
		if(typevs=="chat")	statusMessage1=L"<br><input type=\"button\" value=\"ќ“ –џ“№\" name=\"cmd:42350\" ><input type=\"button\" value=\"«ј –џ“№\" name=\"cmd:700\" ><body bgcolor=\"#53ff53\"><br><b><br><font color=\"#000000\">"+utf8::utf8_wchar(contact->getFullName())+statvs+L" </b><br>"+utf8::utf8_wchar(statusMessage2)+L" </font></body>";
		if(typevs=="away")	statusMessage1=L"<br><input type=\"button\" value=\"ќ“ –џ“№\" name=\"cmd:42350\" ><input type=\"button\" value=\"«ј –џ“№\" name=\"cmd:700\" ><body bgcolor=\"#00cccc\"><br><b><font color=\"#000000\">"+utf8::utf8_wchar(contact->getFullName())+statvs+L" </b><br>"+utf8::utf8_wchar(statusMessage2)+L" </font></body>";
		if(typevs=="xa")	statusMessage1=L"<br><input type=\"button\" value=\"ќ“ –џ“№\" name=\"cmd:42350\" ><input type=\"button\" value=\"«ј –џ“№\" name=\"cmd:700\" ><body bgcolor=\"#7975cb\"><br><b><font color=\"#000000\">"+utf8::utf8_wchar(contact->getFullName())+statvs+L" </b><br>"+utf8::utf8_wchar(statusMessage2)+L" </font></body>";
		if(typevs=="dnd")	statusMessage1=L"<br><input type=\"button\" value=\"ќ“ –џ“№\" name=\"cmd:42350\" ><input type=\"button\" value=\"«ј –џ“№\" name=\"cmd:700\" ><body bgcolor=\"#cc0000\"><br><b><font color=\"#000000\">"+utf8::utf8_wchar(contact->getFullName())+statvs+L" </b><br>"+utf8::utf8_wchar(statusMessage2)+L" </font></body>";
		if(typevs=="online")	statusMessage1=L"<br><input type=\"button\" value=\"ќ“ –џ“№\" name=\"cmd:42350\" ><input type=\"button\" value=\"«ј –џ“№\" name=\"cmd:700\" ><body bgcolor=\"#ffffff\"><br><b><font color=\"#000000\">"+utf8::utf8_wchar(contact->getFullName())+statvs+L" </b><br>"+utf8::utf8_wchar(statusMessage2)+L" </font></body>";
		if(typevs=="offline")	statusMessage1=L"<br><input type=\"button\" value=\"ќ“ –џ“№\" name=\"cmd:42350\" ><input type=\"button\" value=\"«ј –џ“№\" name=\"cmd:700\" ><body bgcolor=\"#777777\"><br><b><font color=\"#ffffff\">"+utf8::utf8_wchar(contact->getFullName())+statvs+L" </b><br>"+utf8::utf8_wchar(statusMessage2)+L" </font></body>";
...
//int result=MessageBox(NULL, TEXT("проба тайм"), TEXT("ќткрыть URL?2"), MB_YESNO | MB_ICONWARNING );
